...
<body style="max-width:380px; margin:0 auto;">
			<div><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/pingNew3/banner.jpg" width="100%" /></div>

	<div class="con2">
   		<div class="gongxi">
			<h2 class="scu">感谢您！</h2>
			<p>参与此次活动</p>
			<p align="center"><a href="http://m.koudailc.com/page/register?isShare=1&source_tag=zhangyue">

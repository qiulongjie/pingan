...
<div  id="denyShow" style="display:none;">
    ...
    <div class="inputcon">
    	<form action="${ctx}/ping/submitGet" name="form1" method="get" onsubmit="return checkForm('a');">
		   ...
		   <input name="failure_path" type="hidden" value="pingNew2_xzbs" />
...
<label for="checkImg">我已阅读相关<a href="#">保险说明</a>,同意免费申请、领取交通意外险</label>
    ...
    <div><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/xiaozhubashi/friendlink.jpg" width="100%" /></div>
  </div> 
</body>

...
<%-- <link rel="stylesheet" type="text/css" href="${ctx }/static/styles/main_lty_d7.css"> --%>
<link rel="stylesheet" type="text/css" href="http://rs.iadcn.com/pingan/static/zhuanpan/styles/main_lty_d7.css">
...
<!-- 弹窗 END -->
	...
	<div class="big_box3">
		...
		<div class="tongzhi">
			<div id="scrollobj" style="white-space:nowrap;overflow:hidden; line-height:32px; color:#885a38;"></div>
		</div>
        ...
        <div class="y_bg3"><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/lty_d_zy/bg3.png"  width="100%" /></div>
    </div>
    
    <div class="con33">
		  	  			<div style="background:url(http://rs.iadcn.com/pingan/static/zhuanpan/images/lty_d_zy/bg_bolang.png) 0 0 repeat-x; width:100%; height:12px; display:block; margin:0; position:relative;z-index:99999;bottom:-8px;"></div>
   	  <div class="conbox3">
			...
			$.ajax({
				...
				success : function(data) {
					if(data.error != '' && data.error != undefined){
						...
						$.session.set('duihuan_code', data.duihuan_code);

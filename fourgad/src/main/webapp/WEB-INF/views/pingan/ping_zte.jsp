...
<%-- 		<img src="${ctx }/static/images/lottery_new/banner.jpg" width="100%"/> --%>
		<img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/ping_zte/zte.jpg" width="100%"/>
	</div>
	
  <div class="con2">
   	  <div class="conbox2">
       	<h3>填写信息领取5-25万交通意外险大礼包</h3>
		<div>
		<form action="${ctx}/ping/submitGet" name="form1" method="get">
		   <input name="code" type="hidden" value="${code }" />
		   <input name="a" type="hidden" value="${a }" />
		   <input name="failure_path" type="hidden" value="ping_zte" />
		   <input name="ok_p" type="hidden" value="ping_zte_ok" />

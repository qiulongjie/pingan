...
<script type="text/javascript" src="http://rs.iadcn.com/pingan/static/js/form_code.js"></script>
...
<%-- 		<img src="${ctx }/static/images/lottery_new/banner.jpg" width="100%"/> --%>
  ...
  <div class="con2">
		...
		<form action="${ctx}/ping/submitGet" name="form1" method="get">
		   ...
		   <input name="failure_path" type="hidden" value="ping_21sjl" />
			...
			<div class="info">
				...
				<p><span>验证：</span><input id="vcode" name="vryCode" type="text" class="m" placeholder="请输入验证码" style="width:60%"/>
 				<img src="${ctx}/ping/go/img" width="20%" height="30px" id="code_img" style="margin-button:0px"/></p>
			</div>
			<div>
				<!-- <a href="#" class="lingqu_btn" onclick="checkForm('s')">立即领取</a> -->
				<input type="button" class="lingqu_btn" value="立即领取" onclick="checkForm('s')" />
			</div>
			<p>*温馨提示：后续降致电以确认免费保障生效事宜，请留意接听。流量徽章降在2-3个工作日内到账。</p>
		</form>
		</div>
		<br class="clear"/>
      </div>
	  ...
	  <div class="hezuo">
			...
			<div>
				<ul>
					<li><a href="#"><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/lottery_new/pingan.png" /></a></li>
					<li><a href="#"><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/lottery_new/renshou.png" /></a></li>
					<li><a href="#"><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/lottery_new/taikang.png" /></a></li>
					<li><a href="#"><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/lottery_new/logo4.png" /></a></li>
				</ul>
			</div>
		 <br class="clear"/>
	  </div>

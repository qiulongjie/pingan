...
<div class="banner">
		<%-- <img src="${ctx }/static/images/ltyas/banner3.jpg" width="100%"/> --%>
		<img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/ltyas/banner3.jpg" width="100%"/>
	</div>
  ...
  <div class="con3">
   	  <div class="conbox2">
       	<h3>填写信息领取大礼</h3>
		<div>
		<form action="${ctx}/ltyZqb/addRewardInfo" name="form1" method="get">

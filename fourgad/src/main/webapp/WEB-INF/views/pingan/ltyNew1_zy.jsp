...
<script type="text/javascript" src="${ctx }/static/js/ltyGongGe_zy.js"></script>
</head>
...
<div  id="yuebingShow" style="display:none;">
	<div class="blackbg"></div>
	<div class="tanchuang">
		<img src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/yuebing_show.png"  width="300" />
	</div>
</div>
...
<div  id="hongbaoShow" style="display:none;">
	<div class="blackbg"></div>
	<div class="tanchuang">
		<div><img id="niwodai_hb_img" src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/hongbao.png" width="300" /></div>
	</div>
</div>
		...
		<div class="choujiang">
			<div id="lottery" class="jiugongge">
				<ul>
					...
					<li class="lottery-unit lottery-unit-7"><img id="zp8_link" src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/8.png" /></li>
					
					<li id="lottery_start"><img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/ltyNew1/9.png" /></li>
					
					<li class="lottery-unit lottery-unit-3"><img id="zp4_link" src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/4.png" /></li>
					<li class="lottery-unit lottery-unit-6"><img id="zp7_link" src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/7.png" /></li>
	...
	<div>
		...
		<div class="jiangxiang">
			<ul>
				...
				<li>
					<img id="jiangping4_link" src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/jiangxiang4.png" />
				</li>
				<li>
				...
				<li>
					<img id="jiangping7_link" src="http://192.168.0.53:8989/fourgad/static/images/zy_gongge/jiangxiang7.png" />
				</li>
				<!-- <li>

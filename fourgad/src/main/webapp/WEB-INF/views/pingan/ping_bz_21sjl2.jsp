...
<form action="${ctx}/ping/submitGet" name="form1" method="get">
	...
	<div class="popupBoxBg slidePopupBox" style="display: none;">
        <div class="popupBoxShow">
            <p>
您获赠<b>25万元</b>平安意外险<br>及30M电信流量包。
            </p>
        </div>
        <div class="fade"></div>
    </div>
...
<div  id="submitFormDiv2" style="display:none;">
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="topWrapper">
            <div class="banner">
                <img src="http://rs.iadcn.com/pingan/static/zhuanpan/images/pingan_bz/banner2.jpg" alt="">
            </div>
            <div class="boxBg">
                <div class="defaultInputBox">
                        ...
                        <span class="introduce" style="padding:5px 0 10px 0px;">提示：30M流量包将直接充值到接收电子保单号的电信手机号码，移动、联通号码无流量赠送</span>
                        </label>
                </div>
       ...
       <input name="isVryCode" type="hidden" value="true" />
	   <input name="failure_path" type="hidden" value="ping_bz_21sjl2" />
                    <table width="100%" border="0">
                      ...
                      <tr>
                        ...
                        <input value="${birthday }" id="txtBirthday" name="birthday" type="text" class="type_ShowGrey" value="如：19800101" onfocus="if(this.value=='如：19800101'){this.value='';this.className='type_ShowBlack'}" onblur="if(this.value==''){this.value='如：19800101';this.className='type_ShowGrey'}"></td>
                      </tr>
                      <tr>
                        <td class="tittleBox">您的手机：</td>
                        <td colspan="2" class="inputBox"><input value="${phone }" id="txtMobile" name="phone" type="text" class="type_ShowGrey" value="接收电子保单号" onfocus="if(this.value=='接收电子保单号'){this.value='';this.className='type_ShowBlack'}" onblur="if(this.value==''){this.value='接收电子保单号';this.className='type_ShowGrey'}" />
                        </td>
                      </tr>
                      <tr>
                        <td class="tittleBox">验证码：</td>
                        <td colspan="2" class="inputBox">
                        <input id="vcode" name="vryCode" type="text" class="type_ShowBlack" placeholder="" style="width:70%"/>

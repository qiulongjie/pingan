...
<%-- <link rel="stylesheet" type="text/css" href="${ctx }/static/styles/pingan_bz_zy.css"> --%>
<link rel="stylesheet" type="text/css" href="http://rs.iadcn.com/pingan/static/zhuanpan/styles/pingan_bz_zy.css">
...
<div  id="submitFormDiv2" style="display:none;">
    ...
    <div id="wrapper" class="wrapper">
       ...
       <input id="ok_p" name="ok_p" type="hidden" value="ping_bz_ok_g_zy" />
       <input name="a" type="hidden" value="${a }" />
	   <input name="failure_path" type="hidden" value="ping_bz_g_zy" />

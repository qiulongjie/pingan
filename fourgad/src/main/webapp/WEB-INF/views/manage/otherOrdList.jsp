	...
	<div class="row">
	 <form class="form-search" action="#">
		  ...
		  <div class="span3">
			  <div class="input-group">
			    <label>接口类别：</label>
			    <select id="inf_type" class="input-medium" >
			    	<option value="4" selected="selected">360新媒体</option>
			    	<option value="5">立其</option>
			    </select>
			  </div>
		  </div>
		  <div class="span3">

...
<body>
	...
	<form id="inputForm" action="${ctx}/count/updateChannel" method="post" class="form-horizontal">
		<fieldset>
			<legend><small>注册渠道</small></legend>
			<input type="hidden" name="id" value="${id }" />
			<input type="hidden" name="channel" value="${channel }" />
			<div class="control-group">
				<label for="channel2" class="control-label">渠道:</label>
				<div class="controls">
					<input type="text" id="channel2" name="channel2" value="${channel }" class="input-large required" minlength="1" disabled=""/>
				</div>
			</div>
			<div class="control-group">
